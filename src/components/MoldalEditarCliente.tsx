...
export default function EditarClienteModal({ isOpen, onClose, idCliente, onAtualizarCliente }: EditarClienteModalProps) {
  ...
  if (loadingCliente) {
    ...
    return isOpen && (
      <Dialog open={isOpen} onClose={onClose} className="fixed inset-0 z-50 flex items-center justify-center">
        <div className="fixed inset-0 " />
        <div className="relative bg-[#100D1E] p-8 text-white border border-[#292343] shadow-xl w-[800px] h-[680px] overflow-y-auto">
          ...
          <div className="flex space-x-4 pt-5 mb-6">
            <div className="w-[185px] h-[40px] flex items-center justify-center">
              <Image
                ...
                onMouseEnter={() => tipoCliente !== 'PF' && setPfImage(PessoaFisicaHover)}
                onMouseLeave={() => tipoCliente !== 'PF' && setPfImage(PessoaFisica)}
            ...
            <div className="w-[185px] h-[40px] flex items-center justify-center">
              <Image
                ...
                onMouseEnter={() => tipoCliente !== 'PJ' && setPjImage(PessoaJuridicaHover)}
                onMouseLeave={() => tipoCliente !== 'PJ' && setPjImage(PessoaJuridica)}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-8">
            ...
            <div className="grid grid-cols-3 gap-4 mb-4 pt-5">
              ...
              <div>
                ...
                <input
                  {...register("cpf_cnpj", {
                    required: true,
                    onChange: (e) =>
                      e.target.value = formatar(e.target.value, tipoCliente === 'PF' ? 'cpf' : 'cnpj')
                  })}
              ...
              <div>
                ...
                })}maxLength={15} className="w-full px-4 py-2 rounded bg-[#1D1933] text-white" />
            ...
            <div className="flex justify-between mt-6 pt-[20px]">
              <button type="button" onClick={onClose} className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#292343] text-white hover:bg-gradient-to-r hover:from-purple-500 hover:to-blue-400 transition">
                <Image src={Voltar} alt="Cancelar" width={17.32} height={15} /> Cancelar
              </button>
              <button type="submit" className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#292343] text-white hover:bg-gradient-to-r hover:from-purple-500 hover:to-blue-400 transition">
