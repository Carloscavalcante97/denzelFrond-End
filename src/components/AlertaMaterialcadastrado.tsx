...
import checkOk from "/public/MaterialCadastrado.svg";
import ok from "/public/Ok.svg";
import Linha from "/public/Linha.png";

interface AlertaMaterialRegistradoProps {
  aberto: boolean;
  onFechar: () => void;
}

export default function AlertaMaterialRegistrado({
  aberto,
  onFechar,
}: AlertaMaterialRegistradoProps) {
  return (
